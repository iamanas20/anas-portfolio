export default [
	{
		id: 'lf',
		title: 'First hire and my 3-year work at Lightfunnels',
		description: 'Reflecting on the past 3 years of my life and the big growth I\'ve undergone.',
		released: false,
		text: `
...
The days went by, I started researching everything about the Netherlands through articles, videos, vlogs etc. This gave me a grasp on culture, history, innovation, human rights, safety, government systems, healthcare, people, and daily life. I fell in love with it all.

I met that family member again in October 2021 and I asked him this "What was the best country you've been to?". He said the Netherlands before even finishing the question, he talked a bit why he choose the Netherlands, he spent time in Amsterdam, the capital and biggest city in the Netherlands.

I decided to look for opportunities and move there because honestly, for me, it is hands down the best country on the planet. Whenever you search for "Top countries in ___" you most likely will find the below-sea-level-land up there among the top 10. The culture, the cities, the services, and the people are really great. I want to be a part of it, work hard, contribute, and grow accustomed to life there.

Leaving Morocco and my work wasn't an easy decision, but I had to make it. I made the decision to leave with dignity and do things right. I have nothing but love and respect to my previous team members, I look up to everyone on that team. I had the opportunity to stand on the shoulders of giants, and I took it. I also have nothing but love for Morocco and its people.
